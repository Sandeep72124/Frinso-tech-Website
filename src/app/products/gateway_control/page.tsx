...
export default function Page() {
  return (
    <div className="flex flex-col">
      {/* Header */}
      <motion.section
        className="min-h-screen bg-gradient-to-r from-cyan-900 via-cyan-800 to-sky-700 text-white flex flex-col items-center py-16 px-6"
        initial="hidden"
        animate="visible"
        variants={fadeUp}
      ...
      >
        <motion.div className="max-w-5xl text-center">
          ...
          >
            <Image
              src="/iot-gateway-controller.png"
              alt="Frinso IoT Gateway"
              width={600}
              height={400}
          ...
          <motion.p
            ...
            transition={{ duration: 1.2 }}
          >
            The <strong>Frinso IoT Gateway & Controller</strong> seamlessly connects
            field sensors, flowmeters, and actuators to the cloud for real-time
