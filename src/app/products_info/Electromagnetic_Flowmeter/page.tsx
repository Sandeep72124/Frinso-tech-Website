...
export default function Page() {
  return (
    <div className="flex flex-col">
      {/* Header */}
      <motion.section
        className="min-h-screen bg-gradient-to-r from-sky-900 via-blue-800 to-gray-700 text-white flex flex-col items-center py-16 px-6"
        initial="hidden"
        animate="visible"
        variants={fadeUp}
      ...
      >
        <motion.div className="max-w-5xl text-center">
          <h1 className="text-4xl font-bold text-sky-300 mb-6">
            Frinso Electromagnetic Flowmeter
          </h1>
          ...
          <motion.p
            ...
            transition={{ duration: 1.2 }}
          >
            The <strong>Frinso Electromagnetic Flowmeter</strong> ensures accurate,
            maintenance-free flow measurement for water and wastewater applications.
            Built for industrial and Smart City telemetry compliance.
          </motion.p>
        </motion.div>
      </motion.section>
